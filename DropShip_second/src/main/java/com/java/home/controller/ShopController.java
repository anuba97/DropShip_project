...
public class ShopController {
	...
	public String painting_item(int work_id, int artist_id, Model model) {
		...
		//System.out.println("DB에서 가져온 workReViewCount : "+workReViewCount);
		System.out.println("DB에서 가져온 workVo : "+workVo);
	...
	public Map<String, Object> workReviewSort_ajax(int work_id, String sort_id, Model model) {
		...
		System.out.println("DB 갖다온 workReViewList : " + workReViewList);
