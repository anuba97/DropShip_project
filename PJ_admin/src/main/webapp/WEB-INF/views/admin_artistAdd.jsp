...
<%-- 						</colgroup> --%>
						<tr>
							<th>작가 이름</th>
							<td>
								<input type="text" name="artist_name" id="artist_name" style="width: 100%;" required>
							</td>
						</tr>
						<tr>
							<th>작가 이름</th>
						...
						<tr>
							<th>출생</th>
							<td>
								<input type="text" name="artist_birth" id="artist_birth" style="width: 100%;" required>
							</td>
						</tr>
						<tr>
							<th>사망</th>
							<td>
								<input type="url" name="artist_death" id="artist_death" style="width: 100%;" required>
							</td>
						</tr>
						<tr>
							<th>주요작품</th>
							<td>
								<textarea id="noticeContent" name="artist_main" cols="50" rows="10" style="width:100%;" required></textarea>
							</td>
						</tr>
						<tr>
							<th>작품 노출 상태</th>
					...
					<div class="admin_noticeBoard_div">
						<button type="button" class="admin_noticeBoard_button" onClick="location.href=''" style="margin: 0 0 0 130px; color:red;">작가 등록</button>
						<button type="button" class="admin_noticeBoard_button" onClick="location.href='admin_workList'" style="margin: 0 auto;">작가 리스트</button>
					</div>
				</form>
			</main>
