                    ...
                    <table class="admin_memberAddTableDiv">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input type="radio" id="portrait" name="work_genre_name" value="초상화" <c:if test="${workVo.getWork_genre_name() == '초상화'}">checked</c:if>>
                                <label for="abstract">추상화</label>
                                <input type="radio" id="abstract" name="work_genre_name" value="추상화" <c:if test="${workVo.getWork_genre_name() == '추상화'}">checked</c:if>>
                                <label for="landScape">풍경</label>
                                <input type="radio" id="landScape" name="work_genre_name" value="풍경" <c:if test="${workVo.getWork_genre_name() == '풍경'}">checked</c:if>>
                                <label for="stillLife">정물</label>
                                <input type="radio" id="stillLife" name="work_genre_name" value="정물" <c:if test="${workVo.getWork_genre_name() == '정물'}">checked</c:if>>
                                <label for="typography">타이포그래피</label>
                                <input type="radio" id="typography" name="work_genre_name" value="타이포그래피" <c:if test="${workVo.getWork_genre_name() == '타이포그래피'}">checked</c:if>><br>
                                <label for="illustration">일러스트</label>
                                <input type="radio" id="illustration" name="work_genre_name" value="일러스트" <c:if test="${workVo.getWork_genre_name() == '일러스트'}">checked</c:if>>
                                <label for="poster">포스터</label>
                                <input type="radio" id="poster" name="work_genre_name" value="포스터" <c:if test="${workVo.getWork_genre_name() == '포스터'}">checked</c:if>>
                                <label for="popArt">팝아트</label>
                                <input type="radio" id="popArt" name="work_genre_name" value="팝아트" <c:if test="${workVo.getWork_genre_name() == '팝아트'}">checked</c:if>>
                                <label for="hyper">초현실</label>
                                <input type="radio" id="hyper" name="work_genre_name" value="초현실" <c:if test="${workVo.getWork_genre_name() == '초현실'}">checked</c:if>>
                                <label for="cartoon">카툰</label>
                                <input type="radio" id="cartoon" name="work_genre_name" value="카툰" <c:if test="${workVo.getWork_genre_name() == '카툰'}">checked</c:if>>
                            </td>
                        </tr>
                        <tr>
                            <th>주제</th>
                            <td>
                                ...
                                <input type="radio" id="spring" name="work_subject_name" value="봄" <c:if test="${workVo.getWork_subject_name() == '봄'}">checked</c:if>>
                                <label for="summer">여름</label>
                                <input type="radio" id="summer" name="work_subject_name" value="여름" <c:if test="${workVo.getWork_subject_name() == '여름'}">checked</c:if>>
                                <label for="fall">가을</label>
                                <input type="radio" id="fall" name="work_subject_name" value="가을" <c:if test="${workVo.getWork_subject_name() == '가을'}">checked</c:if>>
                                <label for="winter">겨울</label>
                                <input type="radio" id="winter" name="work_subject_name" value="겨울" <c:if test="${workVo.getWork_subject_name() == '겨울'}">checked</c:if>>
                                <label for="animals">동물</label>
                                <input type="radio" id="animals" name="work_subject_name" value="동물" <c:if test="${workVo.getWork_subject_name() == '동물'}">checked</c:if>><br>
                                <label for="plants">식물</label>
                                <input type="radio" id="plants" name="work_subject_name" value="식물" <c:if test="${workVo.getWork_subject_name() == '식물'}">checked</c:if>>
                                <label for="city">도시</label>
                                <input type="radio" id="city" name="work_subject_name" value="도시" <c:if test="${workVo.getWork_subject_name() == '도시'}">checked</c:if>>
                                <label for="kids">어린이</label>
                                <input type="radio" id="kids" name="work_subject_name" value="어린이" <c:if test="${workVo.getWork_subject_name() == '어린이'}">checked</c:if>>
                                <label for="indoor">실내</label>
                                <input type="radio" id="indoor" name="work_subject_name" value="실내" <c:if test="${workVo.getWork_subject_name() == '실내'}">checked</c:if>>
...
<!--                         </tr> -->
                        ...
                        <tr>
                            <th>전시 위치</th>
                            <td><input type="url" name="work_dp" id="work_dp" style="width: 100%;" placeholder="옵션" value="${workVo.getWork_dp()}" required></td>
                        </tr>
                        <tr>
                            <th>작품 노출 상태</th>
                            <td>
