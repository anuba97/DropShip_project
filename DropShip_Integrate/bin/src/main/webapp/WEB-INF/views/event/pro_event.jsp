...
<title>EVENT 1 페이지 | DropShip 갤러리</title>
    ...
    <div class="maxinner">
		...
		<form name="fboardlist"  id="fboardlist" action="https://bxgs.co.kr/bbs/board_list_update.php" onsubmit="return fboardlist_submit(this);" method="post">
			...
			<input type="hidden" name="sw" value="">
                ...
                <ul id="bo_cate_ul">
                    <li><a href="all_event?bo_table=event">전체보기</a></li><li><a href="pro_event?bo_table=event&amp;sca=%EC%A7%84%ED%96%89%EC%A4%91+%EC%9D%B4%EB%B2%A4%ED%8A%B8" id="bo_cate_on"><span class="sound_only">열린 분류 </span>진행중 이벤트</a></li><li><a href="final_event?bo_table=event&amp;sca=%EC%A2%85%EB%A3%8C%EB%90%9C+%EC%9D%B4%EB%B2%A4%ED%8A%B8">종료된 이벤트</a></li>                </ul>
            </nav>
            ...
            <div class="grid-event-list">
                                <ul id="gall_ul">
                                        <li>
                                                    ...
                                                    <a href="boardc027.html?bo_table=event&amp;wr_id=25&amp;sca=%EC%A7%84%ED%96%89%EC%A4%91+%EC%9D%B4%EB%B2%A4%ED%8A%B8">
                            ...
                            <div class="event-info">
                                ...
                                <span class="date">2022-05-10 ~ 2022-05-10</span>
                                        ...
                                        <li>
                                                    ...
                                                    <a href="boardc30e.html?bo_table=event&amp;wr_id=24&amp;sca=%EC%A7%84%ED%96%89%EC%A4%91+%EC%9D%B4%EB%B2%A4%ED%8A%B8">
                                                    <div class="event-thumb">
                            ...
                            <div class="event-info">
                                ...
                                <span class="date">2022-05-10 ~ 2022-05-30</span>
                                        ...
                                        <li>
                                                    ...
                                                    <a href="board6155.html?bo_table=event&amp;wr_id=23&amp;sca=%EC%A7%84%ED%96%89%EC%A4%91+%EC%9D%B4%EB%B2%A4%ED%8A%B8">
                                                    <div class="event-thumb">
