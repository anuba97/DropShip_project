...
<!-- Mirrored from bxgs.co.kr/bbs/board.php?bo_table=event&wr_id=22 by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 08 Feb 2023 07:05:37 GMT -->
...
<title>1월 COUPON PACK! > EVENT | DropShip 갤러리</title>
...
<div id="wrap" class="sub">
        ...
        <div class="sitemap">
            <div class="inner">
                ...
                <nav class="all-menu-wrap">
                    ...
                    <ul class="all-menu">
                        <li>
                            <a href="../shop/picture_list.html">Product</a>
                            <ul class="depth">
                                <li><a href="../shop/best_list.html">베스트</a></li>
                                <li><a href="../shop/new_list.html">신상품</a></li>
                                <li><a href="../shop/picture_list.html">사진작품</a></li>
                                <li><a href="../shop/painting_list.html">그림작품</a></li>
                                <li><a href="../shop/artist_list.html">작가별</a></li>
                                <li><a href="../shop/genre_list.html">장르별</a></li>
                                <li><a href="../shop/subject_list.html">주제별</a></li>
                            </ul>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="board8497.html?bo_table=notice">Community</a>
                            <ul class="depth">
                                <li><a href="board8497.html?bo_table=notice">공지사항</a></li>
                                <li><a href="boardfe0e.html?bo_table=event">이벤트</a></li>
                            </ul>
                        </li>
                        <li>
                            ...
                            <ul class="depth">
                                ...
                                <li><a href="qalist.html">1:1 문의</a></li>
                            </ul>
                        </li>
                    </ul>
                </nav>
                <nav class="info-menu-wrap">
                    ...
                    <ul class="info-menu">
                            ...
                            <li><a href="register_intro.html">회원가입</a></li>
                            <li><a href="../shop/personalpay.html">개인결제창</a></li>
                                                <li class="mb-only"><a href="loginbac1.html">주문조회</a></li>
                        <li class="mb-only"><a href="../shop/cart.html">장바구니</a></li>
                    </ul>
                </nav>
        ...
        <ul class="gnb-info">
                            <li><a href="login.html">로그인</a></li>
                <li><a href="register_intro.html">회원가입</a></li>
                        <li><a href="loginbac1.html">주문조회</a></li>
            <li><a href="../shop/cart.html">장바구니<span class="basket-num">0</span></a></li>
            <li><a href="qalist.html">고객센터</a></li>
        </ul>
    </nav>
...
<article id="board-view" class="board">
    <div class="maxinner">
        <header class="board-con-tit">
            ...
            <h2>
                1월 COUPON PACK!            </h2>
            <p><span class="hide">이벤트 기간</span>2022-05-10 ~ 2022-05-10</p>
        </header>
        ...
        <div class="board-con-wrap">
            ...
            <div class="board-con"><p style="text-align: center; " align="center">테스트 글 입니다.</p></div>
        ...
        <div class="board-file-wrap">
            <div class="board-file">
                ...
                <ul>
                                            <li>         
                            <a href="https://bxgs.co.kr/bbs/download.php?bo_table=event&amp;wr_id=22&amp;no=0" class="view_file_download">
                                <img src="/img/ico/ico-file.png" alt="">
                                <strong>thum03.png</strong>
                            </a>
                        </li>
                                    </ul>
            </div>
        ...
        <div class="board-con-move">
                        <ul>
                <li class="prev">
                                            <a href="boardfc4a.html?bo_table=event&amp;wr_id=23">
                ...
                <li class="mid"><a href="boardfe0e.html?bo_table=event"><span class="hide">목록으로</span></a></li>
                <li class="next">
                     
                        <a href="javascript:;" class="link-none">
