            ...
            <div id="faq-wrap" class="faq_1">
                    ...
                    <ol>
                            ...
                            <div class="faq-tit">
                                ...
                                <div class="faq-tit-txt"><p>무통장입금은 언제까지 입금해야 하나요?<br /></p></div>
                                <button class="faq-open" onclick="return faq_open(this);"><span class="hide">열기</span></button>
                            </div>
                            <div class="faq-con">
                                <div class="faq-con-inner">
                                    <p>무통장입금은 주문완료 후 7일 이내 입금해야 합니다. 입금기한 내 입금확인이 되지 않은 주문 건은 자동 취소 됩니다. 결제가 완료된 주문건에 한해서 배송이 진행되므로 주문 취소된 건은</p><p>재주문해주셔야됩니다.</p>                                </div>
                            </div>
                        </li>
                                                <li>
                            <div class="faq-tit">
                                <span class="faq-cate">주문/결제</span>
                                <div class="faq-tit-txt"><p>꼭 회원 가입을 해야만 주문할수 있나요? <br /></p></div>
                                <button class="faq-open" onclick="return faq_open(this);"><span class="hide">열기</span></button>
                            </div>
                            <div class="faq-con">
                                <div class="faq-con-inner">
                                    <p>비회원도 주문이 가능합니다.</p><p>단, 회원가입을 해야지 더 많은 해택을 받으실 수 있습니다.</p>                                </div>
                            </div>
                        </li>
                                                <li>
                            <div class="faq-tit">
                                <span class="faq-cate">배송관련</span>
                                <div class="faq-tit-txt"><p>주문한 상품의 배송기간은 얼마나 되나요?<br /></p></div>
                                <button class="faq-open" onclick="return faq_open(this);"><span class="hide">열기</span></button>
                            </div>
                            <div class="faq-con">
                                <div class="faq-con-inner">
                                    <p>지역별, 기상악화, 천재지변, 택배사 사정에 따라 다소 차이가 날 수 있습니다.<br /></p>                                </div>
                            </div>
                        </li>
                                            </ol>
                </div>
