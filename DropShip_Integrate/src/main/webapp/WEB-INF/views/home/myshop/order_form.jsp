                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td data-title="Product" class="td_prd">
                                                <div class="sod_img">
                                                    <a href="painting_item?id=${workVo.id}" style="background-image: url(/admin/img/work/${workVo.work_img_url})">
                                                        <span class="hide">제품이미지</span>
                                                    </a>
                                                </div>
                                                <div class="sod_name">
                                                    <input type="hidden" name="it_id[0]" value="1654129940">
                                                    <input type="hidden" name="it_name[0]" value="양산을 든 여인 - 카미유와 장"> <input type="hidden" name="it_price[0]" value="74700"> <input type="hidden" name="cp_id[0]" value=""> <input type="hidden" name="cp_price[0]" value="0"> <a href="../home/shop/item.php?it_id=1654129940" class="prd_name">
                                                    <strong>${workVo.getName()}</strong><span>클로드
                                                            모네</span><span class="price_txt"></span>
                                                        <div class="sod_opt_txt">
                                                            <p>
                                                                사이즈 : ${optionVo.option_size}<span class="price_txt">(+${optionVo.option_size_added_price})</span>
                                                            </p>
                                                            <p>
                                                                미디어 : ${optionVo.option_media}<span class="price_txt">(+${optionVo.option_selected_price - optionVo.frame_added_price - optionVo.matt_added_price})</span>
                                                            </p>
                                                            <p>
                                                                리터치 : ${optionVo.option_mattier}<span class="price_txt">(+0)</span>
                                                            </p>
                                                            <p>
                                                                프레임 : ${optionVo.option_frame}<span class="price_txt">(+${optionVo.option_frame_added_price})</span>
                                                            </p>
                                                            <p>
                                                                매트(여백) : ${optionVo.option_matt}<span class="price_txt">(+${optionVo.option_matt_added_price})</span>
                                                            </p>
                                                        </div>
                                                    </a>
                                                </div>
                                            ...
                                            <td data-title="Subtotal" class="td_numbig  text_right"><span class="total_price">${optionVo.option_price * optionVo.option_quantity}</span> 원</td>
                                        ...
                                        <table>
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td><input type="text" name="od_name" value="${memberVo.member_name}" id="od_name" required class="inp-type01 required" maxlength="20"></td>
                                                </tr>


                                                <tr>
                                                    <th scope="row"><label for="od_hp"><span class="f-color">*</span> 핸드폰번호</label></th>
                                                    <td><input type="text" name="od_hp" value="${memberVo.member_phone}" id="od_hp" required class="inp-type01 required" maxlength="20"></td>
                                                </tr>
                                                <tr>
                                                    <th scope="row"><label for="od_tel">전화번호</label></th>
                                                    <td><input type="text" name="od_tel" value="없애버려야" id="od_tel" class="inp-type01" maxlength="20"></td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="od_address_box">
                                                            <div class="od_address_numbox">
                                                                <label for="od_zip" class="sound_only">우편번호</label> <input type="text" name="od_zip" value="${memberVo.member_zip}" id="od_zip" required class="inp-type01 required" size="8" maxlength="6" placeholder="우편번호">
                                            ...
                                            ----->
                                                ...
                                                <tr>
                                                    ...
                                                    <td id="sod_frm_addr">
                                                        <div class="od_address_box">
                                                            <div class="od_address_numbox">
                                                                <label for="od_b_zip" class="sound_only">우편번호<strong class="sound_only"> 필수</strong></label> <input type="text" name="od_b_zip" id="od_b_zip" required class="inp-type01 required" size="8" maxlength="6" placeholder="우편번호">
                                                            ...
                                                            <input type="text" name="od_b_addr1" id="od_b_addr1" required class="inp-type01 frm_address required" size="60" placeholder="기본주소"> <label for="od_b_addr1" class="sound_only">기본주소<strong>
                                                                    필수</strong></label> <input type="text" name="od_b_addr2" id="od_b_addr2" class="inp-type01 frm_address" size="60" placeholder="상세주소"> <label for="od_b_addr2" class="sound_only">상세주소</label> <input type="hidden" name="od_b_addr3" value=""> <input type="hidden" name="od_b_addr_jibeon" value="">
                                                        </div>
                                                    </td>
                                                </tr>
                                                <!-- 주문시 요청사항 항목 추가됨. -->
                                ...
                                <section id="sod_frm_pay">
                                    <div class="sod_right_box sod_right_box2">
                                            ...
                                            <table>
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td><strong>${optionVo.option_price * optionVo.option_quantity}</strong> 원</td>
                                                    </tr>
                                                    <tr>
                                                        <th scope="row">배송비</th>
                                        ...
                                        <div id="od_tot_price">
                                            <span>최종 결제 금액</span>
                                            <div>
                                                <strong class="print_price">${optionVo.option_price * optionVo.option_quantity}</strong>원
                                            </div>
                                        </div>
                                    </div>
