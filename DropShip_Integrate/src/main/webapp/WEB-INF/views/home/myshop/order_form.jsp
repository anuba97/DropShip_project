        ...
        <div class="maxinner">
            ...
            <div class="sod_od_prd_wrap">
                <div class="sod_list_tit">
                    <h3>주문상품</h3>
                    <p><span class="f-color">*</span>제주/도서산간 지역의 경우 추가 배송비가 발생할 수 있습니다.</p>
                </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td data-title="Product" class="td_prd">
                                    ...
                                    <div class="sod_name">
                                        <input type="hidden" name="it_id[0]"    value="1654129940">
                                        <input type="hidden" name="it_name[0]"  value="양산을 든 여인 - 카미유와 장">
            ...
            <div class="sod_od_contents_wrap">
                <div class="sod_left">
                    <input type="hidden" name="od_price"    value="74700">
                    <input type="hidden" name="org_od_price"    value="74700">
                    <input type="hidden" name="od_send_cost" value="2000">
                    <input type="hidden" name="od_send_cost2" value="0">
                    <input type="hidden" name="item_coupon" value="0">
                    <input type="hidden" name="od_coupon" value="0">
                    <input type="hidden" name="od_send_coupon" value="0">
                    <input type="hidden" name="od_goods_name" value="양산을 든 여인 - 카미유와 장">

                        <input type="hidden" name="req_tx"          value="pay">
    <input type="hidden" name="site_cd"         value="T0000">
    <input type="hidden" name="site_name"       value="백상">
    <input type="hidden" name="def_site_cd"     value="T0000">

    <!-- <input type="hidden" name="KCP_PAY_MODULE"  value="kcp_web" > -->
    <input type="hidden" name="pay_method"  value="">
    <input type="hidden" name="ordr_idxx"   value="2023031515380329">
                    ...
                    <section id="sod_frm_orderer">
                        ...
                        <div class="tbl_frm01 tbl_wrap">
                            ...
                            <tr>
                                ...
                                <td><input type="text" name="od_name" value="오민수" id="od_name" required class="inp-type01 required" maxlength="20"></td>
                            </tr>

                            
                            <tr>
                                <th scope="row"><label for="od_hp"><span class="f-color">*</span> 핸드폰번호</label></th>
                                <td><input type="text" name="od_hp" value="010-5880-3916" id="od_hp" required class="inp-type01 required" maxlength="20"></td>
                            </tr>
                            <tr>
                                <th scope="row"><label for="od_tel">전화번호</label></th>
                                <td><input type="text" name="od_tel" value="028394015" id="od_tel" class="inp-type01" maxlength="20"></td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <div class="od_address_box">
                                        <div class="od_address_numbox">
                                            ...
                                            <input type="text" name="od_zip" value="08555" id="od_zip" required class="inp-type01 required" size="8" maxlength="6" placeholder="우편번호">
                                            <button type="button" class="btn_address btnset btn-type03 btn-fill-brown" onclick="win_zip('forderform', 'od_zip', 'od_addr1', 'od_addr2', 'od_addr3', 'od_addr_jibeon');">우편번호 검색</button>
                                        </div>
                                        <input type="text" name="od_addr1" value="서울 금천구 독산동 181-34" id="od_addr1" required class="inp-type01 frm_address required" size="60" placeholder="기본주소">
                                        <label for="od_addr1" class="sound_only">기본주소<strong class="sound_only"> 필수</strong></label>
                                        <input type="text" name="od_addr2" value="3층" id="od_addr2" class="inp-type01 frm_address" size="60" placeholder="상세주소">
                            ...
                            <tr>
                                ...
                                <td><input type="text" name="od_email" value="alstn85851@naver.com" id="od_email" required class="inp-type01 required" size="35" maxlength="100"></td>
                            </tr>
...
<li>
<input type="radio" name="ad_sel_addr" value="홍길동028394015010-5880-391608555서울 금천구 독산동 181-343층집" id="ad_sel_addr_1"> 
<label for="ad_sel_addr_1">최근배송지(집)</label>
</li>
<li>
...
<a href="javascript:;" id="order_address" class="btn_frmline btnset btn-type03 btn-fill-brown btn-pop-open" data-popnum="01">배송지 목록</a></li>
                                            ...
                                            <div class="pop-wrap pop01" id="pop-addr">
                                                <div class="pop-inner">
                                                    ...
                                                    <div class="pop-con-wrap">
                                                        ...
                                                        <form name="" method="" action="">
                                                            <div class="form-box">
                                                                <div class="left-con"><label for="fm_addr_loc">배송지명</label></div>
                                                                <div class="right-con">
                                                                    <div class="addr-loc-box">
                                                                        <input type="text" name="" id="fm_addr_loc" class="inp-type01">
                                                                        <div class="chk-box">
                                                                            <input type="checkbox" name="" id="fm_addr_basic" value="">
                                                                            <label for="fm_addr_basic">기본배송지로 저장</label>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="form-box">
                                                                <div class="left-con"><label for="fm_addr_name">받는사람</label></div>
                                                                <div class="right-con">
                                                                    <input type="text" name="" id="fm_addr_name" class="inp-type01">
                                                                </div>
                                                            </div>
                                                            <div class="form-box">
                                                                <div class="left-con"><label for="fm_addr_hp">핸드폰번호</label></div>
                                                                <div class="right-con">
                                                                ...
                                                                <div class="right-con">
                                                                    <div class="fm-addr-box-wrap">
                                                                        <div class="fm-addr-numbox">
                                                                            <label for="fm_addr_zip" class="sound_only">우편번호<strong class="sound_only"> 필수</strong></label>
                                                                            <input type="text" name="fm_addr_zip" id="fm_addr_zip" required class="inp-type01 required" size="8" maxlength="6" placeholder="우편번호">
                                                                            <button type="button" class="btn_address btnset btn-type03 btn-fill-brown" onclick="win_zip('', 'fm_addr_zip', 'fm_addr_1', 'fm_addr_2', 'fm_addr_3', 'fm_addr_jibeon');">우편번호 검색</button>
                                                                        </div>
                                                                        <div class="fm-addr-box">
                                                                            <input type="text" name="fm_addr_1" id="fm_addr_1" required class="inp-type01 frm_address required" size="60" placeholder="기본주소">
                                                                            <label for="fm_addr_1" class="sound_only">기본주소<strong> 필수</strong></label>
                                                                            <input type="text" name="fm_addr_2" id="fm_addr_2" class="inp-type01 frm_address" size="60" placeholder="상세주소">
                                                                            <label for="fm_addr_2" class="sound_only">상세주소</label>
                                                                            <input type="hidden" name="fm_addr_3" value="">
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="text" name="od_b_tel" id="od_b_tel" class="inp-type01" maxlength="20"></td>
                                    </tr> 
                                    <tr>
                                        <th scope="row"><span class="f-color">*</span> 주소</th>
                                        <td id="sod_frm_addr">
                                            <div class="od_address_box">
                                                <div class="od_address_numbox">
                                                    ...
                                                    <button type="button" class="btn_address btnset btn-type03 btn-fill-brown" onclick="win_zip('forderform', 'od_b_zip', 'od_b_addr1', 'od_b_addr2', 'od_b_addr3', 'od_b_addr_jibeon');">우편번호 검색</button>
                                                </div>
                                                <input type="text" name="od_b_addr1" id="od_b_addr1" required class="inp-type01 frm_address required" size="60" placeholder="기본주소">
                                                <label for="od_b_addr1" class="sound_only">기본주소<strong> 필수</strong></label>
                                                <input type="text" name="od_b_addr2" id="od_b_addr2" class="inp-type01 frm_address" size="60" placeholder="상세주소">
                                    ...
                                    <tr>
                                        <th scope="row">
                                            <label for="od_b_request">배송 요청사항</label>
                                        </th>
                                        <td>
                                            <div class="b_box">
                    ...
                    <section id="sod_frm_pay">
                        <div class="sod_right_box sod_right_box2">
                                ...
                                <table>
                                    <tbody>
                                        ...
                                        <tr>
                                            <th scope="row">배송비</th>
                                            <td>
                                                <strong>+</strong> <strong>2,000</strong> 원
                                            </td>
                                        </tr>
                                        <tr>
                                            <th>추가배송비</th>
                                            <td>
                                                <strong>+</strong> <strong id="od_send_cost2">0</strong> 원
                                            ...
                                            <td>
                                                <strong>-</strong> <strong id="od_cp_price2">0</strong> 원
                                            </td>
                                        </tr>
                                        <tr>
                                            <th scope="row">적립예상 마일리지</th>
                                            <td>
                                                <strong>+</strong> <strong>3,000</strong> 점
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                            ...
                            <div id="od_tot_price">
                                <span>최종 결제 금액</span>
                                <div>
                                                                        <strong class="print_price">76,700</strong>원
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="sod_right_box sod_right_box3">
                            <div id="od_pay_sl">
                                <div class="od_pay_buttons_el">
                                    ...
                                    <p id="sod_frm_pt_alert">* <strong>무통장입금</strong> 이외의 결제 수단으로 결제하시는 경우 마일리지를 적립해드리지 않습니다.</p><fieldset id="sod_frm_paysel"><legend>결제방법 선택</legend><input type="radio" id="od_settle_bank" name="od_settle_case" value="무통장" > <label for="od_settle_bank" class="lb_icon bank_icon">무통장입금</label>
                                    
                                    <div id="settle_bank" style="display:none"><label for="od_bank_account" class="sound_only">입금할 계좌</label><input type="hidden" name="od_bank_account" value="OO은행 12345-67-89012 예금주명">OO은행 12345-67-89012 예금주명
<br><div class="od_bank_person"><label for="od_deposit_name">입금자명</label> <input type="text" name="od_deposit_name" id="od_deposit_name" size="10" maxlength="20"></div></div></fieldset>                                    <div class="sod_frm_point">
                                        <div class="sod_use_point_box">
                                            <label for="od_temp_point">사용 마일리지<span>(100점 단위)</span></label>
                                        ...
                                        <div class="sod_my_point_box" id="sod_frm_pt">
                                            ...
                                            <div class="max_point_box">
                                                <span>최대 사용 가능 마일리지</span>
                                                <em id="use_max_point"><strong>0</strong> 점</em>
                                            </div>
                                        </div>
                                    </div>
                                                                                                        </div>
    ...
    if (typeof(f.od_temp_point) != "undefined") {
        ...
        if (f.od_temp_point.value)
        {
            ...
            if (parseInt(parseInt(temp_point / point_unit) * point_unit) != temp_point) {
                alert("마일리지를 "+String(point_unit)+"점 단위로 입력하세요.");
                f.od_temp_point.select();
                return false;
            }
        }
