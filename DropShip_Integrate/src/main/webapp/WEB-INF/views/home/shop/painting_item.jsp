...
-->
	...
	<!-- 다른 그림작품 14개 시작(상단 1개그림 제외) { -->
		<div class="sct-slider">
		  <ul class="swiper-wrapper sct">
		          ...
		          <div class="sct_opt_wrap">
		            <div class="sct_btn">
		              ...
		              <div class="sct_op_btn">
		                <a href="painting_item" class="btnset btn-sight"><span class="hide">자세히보기</span></a>
		                <button type="button" class="btnset btn-like btn_wish" data-it_id="1654135291"><span class="hide">찜하기</span></button>
		              </div>
		          </div>
		        </div>
		        <div class="sct_txt"><a href="painting_item" class="sct_a">베르농의 테라스</a></div>
		        <div class="sct_desc"><span>피에르 보나르</span><p>20.0cm x 35.7cm</p></div>
		    ...
		    <li class="swiper-slide sct_li">
		      <div class="li_wr">
		        <div class="sct_img_wrap">
		          <div class="sct_img" style="background-image:url(../home/data/item/1654134107/67OE6rO87IKs7J207ZSE65s7Iqk64KY66y06rCA7J6I64qU6ri4.jpg)">
		        ...
		        <div class="sct_txt"><a href="painting_item" class="sct_a">밤의 프로방스 시골길</a></div>
		    ...
		    <li class="swiper-slide sct_li">
		      <div class="li_wr">
		        <div class="sct_img_wrap">
		          <div class="sct_img" style="background-image:url(../home/data/item/1654133954/67CA7Kea66qo7J6Q66W87JO07J6Q7ZmU7IOB.jpg)">
		        ...
		        <div class="sct_txt"><a href="painting_item" class="sct_a">밀짚 모자를 쓴 자화상</a></div>
		        <div class="sct_desc"><span>빈센트 반 고흐</span><p>20.0cm x 35.7cm</p></div>
		        <div class="sct_cost"><span class="price_cost"><strong>38,200</strong>원</span></div>
			  </div>
			</li>
		    ...
		    <li class="swiper-slide sct_li">
		      <div class="li_wr">
		        ...
		        <div class="sct_txt"><a href="painting_item" class="sct_a">아를의 랑그루아 다리</a></div>
		        <div class="sct_desc"><span>빈센트 반 고흐</span><p>20.0cm x 35.7cm</p></div>
		        <div class="sct_cost"><span class="price_cost"><strong>38,200</strong>원</span></div>
			  </div>
			</li>
		    ...
		    <li class="swiper-slide sct_li">
		      <div class="li_wr">
		        <div class="sct_img_wrap">
		          <div class="sct_img" style="background-image:url(../home/data/item/1652406953/7IiY66Co7Jew66q7.png)">
		            <span class="hide">수련연못</span>
		          </div>
		          <div class="sct_opt_wrap">
		            <div class="sct_btn">
		        ...
		        <div class="sct_txt"><a href="painting_item" class="sct_a">수련연못</a></div>
		        <div class="sct_desc"><span>클로드 모네</span><p>20.0cm x 35.7cm</p></div>
		        <div class="sct_cost"><span class="price_cost"><strong>98,000</strong>원</span></div>
			  </div>
			</li>
		    ...
		    <li class="swiper-slide sct_li">
		      <div class="li_wr">
		        ...
		        <div class="sct_txt"><a href="painting_item" class="sct_a">앙티브이 아침</a></div>
		        <div class="sct_desc"><span>클로드 모네</span><p>20.0cm x 35.7cm</p></div>
		    ...
		    <li class="swiper-slide sct_li">
		      <div class="li_wr">
		        ...
		        <div class="sct_txt"><a href="painting_item" class="sct_a">지베르니 봄의 효과</a></div>
		        <div class="sct_desc"><span>클로드 모네</span><p>20.0cm x 35.7cm</p></div>
		    ...
		    <li class="swiper-slide sct_li">
		      <div class="li_wr">
		        <div class="sct_img_wrap">
		          <div class="sct_img" style="background-image:url(../home/data/item/1654135804/7JWE66qs65Oc64KY66y0.jpg)">
		        ...
		        <div class="sct_txt"><a href="painting_item" class="sct_a">꽃 피는 아몬드 나무</a></div>
		        <div class="sct_desc"><span>빈센트 반 고흐</span><p>20.0cm x 35.7cm</p></div>
		        <div class="sct_cost"><span class="price_cost"><strong>36,500</strong>원</span></div>
			  </div>
			</li>
		    ...
		    <li class="swiper-slide sct_li">
		      <div class="li_wr">
		        ...
		        <div class="sct_txt"><a href="painting_item" class="sct_a">키스</a></div>
		    ...
		    <li class="swiper-slide sct_li">
		      <div class="li_wr">
		        ...
		        <div class="sct_txt"><a href="painting_item" class="sct_a">아테제 호수</a></div>
		        <div class="sct_desc"><span>구스타프 클림트</span><p>20.0cm x 35.7cm</p></div>
		    ...
		    <li class="swiper-slide sct_li">
		      <div class="li_wr">
		        <div class="sct_img_wrap">
		          <div class="sct_img" style="background-image:url(../home/data/item/1654129940/shutterstock_423234622.jpg)">
		        ...
		        <div class="sct_txt"><a href="painting_item" class="sct_a">양산을 든 여인 - 카미유와 장</a></div>
		        <div class="sct_desc"><span>클로드 모네</span><p>20.0cm x 35.7cm</p></div>
		        <div class="sct_cost"><span class="price_cost"><strong>38,200</strong>원</span></div>
			  </div>
			</li>
		    ...
		    <li class="swiper-slide sct_li">
		      <div class="li_wr">
		        <div class="sct_img_wrap">
		          <div class="sct_img" style="background-image:url(../home/data/item/1654129449/7IS464qQ6rCV7J2Y67SE.png)">
		        ...
		        <div class="sct_txt"><a href="painting_item" class="sct_a">세느강의 봄</a></div>
		        <div class="sct_desc"><span>클로드 모네</span><p>20.0cm x 35.7cm</p></div>
		        <div class="sct_cost"><span class="price_cost"><strong>36,500</strong>원</span></div>
			  </div>
			</li>
		    ...
		    <li class="swiper-slide sct_li">
		      <div class="li_wr">
		        <div class="sct_img_wrap">
		          <div class="sct_img" style="background-image:url(../home/data/item/1653898590/7IKw7KeA6riw7J2Y7KeR.png)">
		            <span class="hide">산지기의 집</span>
		          </div>
		          <div class="sct_opt_wrap">
		            <div class="sct_btn">
		              <button type="button" class="btnset btn-type01 btn_cart sct_cart" data-it_id="1653898590">
		                <svg height="45" width="160"><rect height="45" width="160"></rect></svg>
		                <span>ADD TO CART</span>
		              </button>
		            </div>
		              ...
		              <div class="sct_op_btn">
		                <a href="painting_item" class="btnset btn-sight"><span class="hide">자세히보기</span></a>
		                <button type="button" class="btnset btn-like btn_wish" data-it_id="1653898590"><span class="hide">찜하기</span></button>
		              </div>
		          </div>
		        </div>
		        <div class="sct_txt"><a href="painting_item" class="sct_a">산지기의 집</a></div>
		        <div class="sct_desc"><span>구스타프 클림트</span><p>20.0cm x 35.7cm</p></div>
		        <div class="sct_cost"><span class="price_cost"><strong>42,400</strong>원</span></div>
			  </div>
			</li>
		    ...
		    <li class="swiper-slide sct_li">
		      <div class="li_wr">
		        <div class="sct_img_wrap">
		          <div class="sct_img" style="background-image:url(../home/data/item/1652406619/7Jes7J24.png)">
		        ...
		        <div class="sct_txt"><a href="painting_item" class="sct_a">헤르미네 갈리아의 초상</a></div>
		        <div class="sct_desc"><span>구스타프 클림트</span><p>20.0cm x 35.7cm</p></div>
		        <div class="sct_cost"><span class="price_cost"><strong>36,500</strong>원</span></div>
			  </div>
			</li>
	    ...
	    <div class="swiper-button-prev cursor-able"></div><div class="swiper-button-next cursor-able"></div><div class="swiper-pagination"></div><!-- } 상품진열 끝 -->        </div>
	  </div> 
	</div>  
		...
		<div id="sit_inf_explan">
			...
			<div class="sit_inf_explan_item">
				...
				<div class="item_frame_wrap">
					<div class="item_img" style="background-image:url(../home/data/item/1654133092/6rOg7Z2Q67K867Kg64qU64aN67aA.jpg)"><span class="hide">제품이미지</span></div>
				</div>
