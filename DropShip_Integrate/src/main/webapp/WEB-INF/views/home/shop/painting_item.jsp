                                ...
                                <ul class="swiper-wrapper sct">
                                    <li class="swiper-slide sct_li">
                                        <div class="li_wr">
                                            ...
                                            <div class="sct_desc"><span>피에르 보나르</span>
                                                <p>20.0cm x 35.7cm</p>
                                            </div>
                                    ...
                                    <li class="swiper-slide sct_li">
                                        <div class="li_wr">
                                            ...
                                            <div class="sct_desc"><span>빈센트 반 고흐</span>
                                                <p>20.0cm x 35.7cm</p>
                                            </div>
                                    ...
                                    <li class="swiper-slide sct_li">
                                        <div class="li_wr">
                                            ...
                                            <div class="sct_desc"><span>클로드 모네</span>
                                                <p>20.0cm x 35.7cm</p>
                                            </div>
                                    ...
                                    <li class="swiper-slide sct_li">
                                        <div class="li_wr">
                                            ...
                                            <div class="sct_desc"><span>구스타프 클림트</span>
                                                <p>20.0cm x 35.7cm</p>
                                            </div>
                                            <div class="sct_cost"><span class="price_cost"><strong>36,500</strong>원</span></div>
                                        </div>
                                ...
                                <div class="sit_inf_explan_item">
                                    ...
                                    <div class="item_desc_wrap">
                                        ...
                                        <div class="item_desc_con">
                                            <p>빈센트 반 고흐는 장 프랑수아 밀레(Jean Francois Millet)의 &lt;씨 뿌리는 사람&gt;(1850) 및 &lt;이삭 줍는 여인들-이삭줍기&gt;(1857)와 같은 작품들에서 영감을 받아 농촌에서 행해지는 일들에 관심이 많았고,</p>
                                            <p>그와 관련한 다수의 연작들을 그렸다. 농사는 대지에 대한 신의 은총을 가져오는 인간의 역할을 나타내는 상징적 의미가 있다.</p>
                                            <p>이러한 개념은 장 자크 루소(Jean-Jacques Rousseau)의 개념을 토대로한 낭만주의 운동의 기본 철학이기도 했지만, 반 고흐의 강한 신념의 중심이기도 했다.</p>
                                            <p>반 고흐는 그의 동생 테오(Theo)에게 보내는 편지에서도 이러한 주제에 대해 말한 적이 있다.</p>
                                            <p>“농부는 일요일에 신사복 같은 것을 입고 교회에 갈 때보다 거친 옷을 입고 들판에서 일할 때가 더 아름답다.”</p>
                                            <p>그리고 이 작품을 그리게 된 연유에 대해서 여동생에게 보낸 편지에 다음과 같이 고백하고 있다.</p>
                                            <p><br></p>
                                            <p>“그때 나는 수확을 끝내려고 아주 열심히 일하고 있는 사람들에게서 죽음의 이미지를 보았다. 그것은 그 사람이 베고 있는 밀이 인간이라는 의미에서이다.</p>
                                            <p>그렇다면 이것은 내가 얼마 전에 그렸던 &lt;씨 뿌리는 사람&gt;(1888)과는 상반되는 그림이다. 그러나 이 죽음은 모든 것을 순수한 황금빛으로 물들이는 한낮의 태양 아래에서 일어났기 때문에 전혀 슬프지 않다.”</p>
                                            <p>깊은 정신세계를 보여주는 그의 이러한 말들은 작품에 중요한 의미를 부여하면서도, 또한 반 고흐 자신에게 곧 다가올 죽음을 예견하는 듯하다.</p>
                                            <p><br></p>
                                            <p>이 주제의 연작은 사실상 1889년 7월에 그리려고 의도했던 것인데, 뜻하지 않게 찾아온 발작으로 계획이 중단되었고 하반기가 되어서야 작업이 재개될 수 있었다. 이 작품은 처음 완성된 그림의 두 번째 버전이다.</p>
                                            <p>들에서 수확을 하고 있는 농부의 모습과 더불어 수확기의 황금빛 밀밭의 색채가 내는 효과가 보는 이의 시선을 사로잡는다.</p>
                                            <p>반 고흐는 눈앞에 있는 대상을 정확하게 재현하려고 애쓰기 보다는 오히려 자신의 존재를 강하게 표현하게 위해 내면의 빛을 찾고자 했으며, 그에 따라 색채를 더 자유롭게 사용하고자 했음을 알 수 있다.</p>
                                            <!--
                                ...
                                <div class="sit_inf_explan_artist">
                                    ...
                                    <div class="artist_info_wrap">
                                        ...
                                        <div class="artist_desc">
                                            <p><span style="color: rgb(102, 102, 102);">네덜란드의 후기 인상주의 화가. 짧은 생애였지만 가장 유명한 미술가로 남아있다.</span></p>
                                            <p><span style="color: rgb(102, 102, 102);">초기 작품은 어두운 색조의 작품이었고, 후기 작품은 표현주의의 경향을 보였다.</span></p>
                                            <p><span style="color: rgb(102, 102, 102);">고흐의 작품은 20세기 미술운동인 야수주의와 독일 표현주의가 발전할 수 있는 토대를 제공했다.</span></p>
                                        </div>
