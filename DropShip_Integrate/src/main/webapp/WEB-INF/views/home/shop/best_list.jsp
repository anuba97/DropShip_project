	...
	<ul class="sct sct_20">
		...
		<li class="sct_li">
		  <div class="li_wr">
			...
			<div class="sct_txt"><a href="painting_item" class="sct_a">앙티브이 아침</a></div><div class="sct_desc"><span>클로드 모네</span><p>20.0cm x 35.7cm</p></div><div class="sct_cost"><span class="price_cost"><strong>35,700</strong>원</span></div>
		  </div>
		</li>
		  ...
		  <div class="li_wr">
			<div class="sct_img_wrap">
			  ...
			  <div class="sct_opt_wrap">
				...
				<div class="cart-layer"></div>
				<div class="sct_op_btn">
				<a href="painting_item" class="btnset btn-sight">
				 <span class="hide">자세히보기</span>
				</a>
				<button type="button" class="btnset btn-like btn_wish" data-it_id="1652406511">
				  <span class="hide">찜하기</span>
				</button>
				</div>
			  </div>
			</div><div class="sct_txt"><a href="painting_item" class="sct_a">아테제 호수</a></div>
			<div class="sct_desc"><span>구스타프 클림트</span><p>20.0cm x 35.7cm</p></div>
			<div class="sct_cost"><span class="price_cost"><strong>42,400</strong>원</span>
			</div>
		  </div>
		</li>
	</ul><!-- } 상품진열 20 끝 --></div>
