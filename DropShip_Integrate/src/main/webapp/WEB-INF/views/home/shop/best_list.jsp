			...
			<c:forEach items="${list}" var="workVo">
				<li class="sct_li">
				  ...
				  <div class="li_wr">
					...
					<div class="sct_txt"><a href="painting_item?id=${workVo.getId()}" class="sct_a">${workVo.getWork_name()}</a></div>
					<div class="sct_desc"><span>${workVo.getArtist_name()}</span><p>20.0cm x 35.7cm</p></div>
					<div class="sct_cost"><span class="price_cost"><strong>${workVo.getWork_price()}</strong>원</span></div>
				  </div>
				</li>
			</c:forEach>
		</ul>
