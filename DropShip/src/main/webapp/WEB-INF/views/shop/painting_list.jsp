...
<html lang="ko">
	...
	<head>
		...
		<script src="../theme/buzinga/js/base.js"></script>
		<script src="../theme/buzinga/js/sub.js"></script>
		<script>
		...
		$(document).ready(function() {
	        $("#button1, #button2").on("click", function() {
	          ...
	          if ($("#button1").hasClass("pressed") && $("#button2").hasClass("pressed")) {
	            $("#newButton").show();
	          } else {
	            $("#newButton").hide();
	          }
									...
									<div class="swiper-wrapper">
										<div class="swiper-slide">
											<div class="ranking-img-wrap">
												<a href="painting_item">
													<div class="ranking-img"
														style="background-image: url(../data/item/1654133092/6rOg7Z2Q67K867Kg64qU64aN67aA.jpg)">
										...
										<div class="swiper-slide">
											<div class="ranking-img-wrap">
												<a href="painting_item">
													<div class="ranking-img"
														style="background-image: url(../data/item/1652406953/7IiY66Co7Jew66q7.png)">
														<span class="hide">배경이미지</span>
													</div>
												</a>
											</div>
										...
										<div class="swiper-slide">
											<div class="ranking-desc-wrap">
												<h4 class="ranking-title">
													<a href="painting_item">수확하는 사람</a>
												</h4>
						...
						<div class="maxinner">
							<div class="sub-con-tit-wrap">
								<h3 class="sub-con-tit" data-aos="fade-right"
									data-aos-delay="100">Painting Art</h3>
							</div>
							<div class="grid-list-opt">
								<div class="grid-opt-left">
									총 <strong class="f-color">15</strong>개의 상품이 있습니다.
								</div>
								<div class="grid-opt-right">
									<div class="grid-sort-list">
										...
										<ul>
											<li><a
												href="painting_listb11a.html?&amp;sort=it_sum_qty&amp;sortodr=desc&amp;re_items=&amp;page=1#item-list-wrap">인기순</a></li>
											<li><a
												href="painting_list1775.html?&amp;sort=it_use_cnt&amp;sortodr=desc&amp;re_items=&amp;page=1#item-list-wrap">후기순</a></li>
											<li><a
												href="painting_list0dd6.html?&amp;sort=it_use_avg&amp;sortodr=desc&amp;re_items=&amp;page=1#item-list-wrap">평점순</a></li>
											<li><a
												href="painting_list4a91.html?&amp;sort=it_update_time&amp;sortodr=desc&amp;re_items=&amp;page=1#item-list-wrap">등록순</a></li>
											<li><a
												href="painting_listb37f.html?&amp;sort=it_price&amp;sortodr=desc&amp;re_items=&amp;page=1#item-list-wrap">높은가격순</a></li>
											<li><a
												href="painting_list28e0.html?&amp;sort=it_price&amp;sortodr=asc&amp;re_items=&amp;page=1#item-list-wrap">낮은가격순</a></li>
										</ul>
									</div>
									<div class="grid-sort-list">
										<a href="javascript:;" class="grid-sort-current btn-sort-open">
										...
										<ul>
											<li><a
												href="painting_list97e6.html?&amp;re_items=9&amp;sort=&amp;sortodr=&amp;page=1#item-list-wrap">9개씩
													보기</a></li>
											<li><a
												href="painting_list556e.html?&amp;re_items=12&amp;sort=&amp;sortodr=&amp;page=1#item-list-wrap">12개씩
													보기</a></li>
										</ul>
									</div>
								</div>
									...
									<ul class="sct sct_20">
										<li class="sct_li">
											<div class="li_wr">
												<div class="sct_img_wrap">
													<div class="sct_img"
														style="background-image: url(../data/item/1654135291/67KE64W87J2Y7YWM65287Iqk.jpg)">
													...
													<div class="sct_opt_wrap">
														<div class="sct_btn list-10-btn">
															<button type="button"
																...
																data-it_id="1654135291">
																<svg height="45" width="160">
																	<rect height="45" width="160"></rect></svg>
																<span>ADD TO CART</span>
															</button>
														</div>
														<div class="cart-layer"></div>
														<div class="sct_op_btn">
															<a href="painting_item" class="btnset btn-sight"><span
																class="hide">자세히보기</span></a>
												...
												<div class="sct_txt">
													<a href="painting_item" class="sct_a">베르농의 테라스</a>
												</div>
												<div class="sct_desc">
													<span>피에르 보나르</span>
													<p>20.0cm x 35.7cm</p>
												...
												<div class="sct_cost">
													<span class="price_cost"> <strong>46,400</strong>원</span> 
													<input type="checkbox" id="button1" name="compare" onclick="checkButtons()">
													<label for="compare">비교하기</label>
										...
										<li class="sct_li">
											<div class="li_wr">
												<div class="sct_img_wrap">
													<div class="sct_img"
														style="background-image: url(../data/item/1654134107/67OE6rO87IKs7J207ZSE65s7Iqk64KY66y06rCA7J6I64qU6ri4.jpg)">
												...
												<div class="sct_txt">
													<a href="painting_item" class="sct_a">밤의 프로방스 시골길</a>
												</div>
												<div class="sct_desc">
													<span>빈센트 반 고흐</span>
													<p>20.0cm x 35.7cm</p>
												...
												<div class="sct_cost">
													...
													<input type="checkbox" id="button2" name="compare" onclick="checkButtons()">
													<label for="compare">비교하기</label>
												</div>
											</div>
										</li>
										...
										<li class="sct_li">
											<div class="li_wr">
												<div class="sct_img_wrap">
													<div class="sct_img"
														style="background-image: url(../data/item/1654133954/67CA7Kea66qo7J6Q66W87JO07J6Q7ZmU7IOB.jpg)">
												...
												<div class="sct_txt">
													<a href="painting_item" class="sct_a">밀짚 모자를 쓴 자화상</a>
												</div>
												<div class="sct_desc">
													<span>빈센트 반 고흐</span>
													<p>20.0cm x 35.7cm</p>
												...
												<div class="sct_cost">
													<span class="price_cost"><strong>38,200</strong>원</span><input
														type="checkbox" name="compare"> <label
														for="compare">비교하기</label>
												</div>
											</div>
										</li>
										...
										<li class="sct_li">
											<div class="li_wr">
												<div class="sct_img_wrap">
													<div class="sct_img"
														style="background-image: url(../data/item/1654133549/656R6re466Oo7JWE64uk66as.jpg)">
												...
												<div class="sct_txt">
													<a href="painting_item" class="sct_a">아를의 랑그루아 다리</a>
												</div>
												<div class="sct_desc">
													<span>빈센트 반 고흐</span>
													<p>20.0cm x 35.7cm</p>
										...
										<li class="sct_li">
											<div class="li_wr">
												...
												<div class="sct_txt">
													<a href="painting_item" class="sct_a">수확하는 사람</a>
												</div>
												<div class="sct_desc">
													<span>빈센트 반 고흐</span>
													<p>20.0cm x 35.7cm</p>
										...
										<li class="sct_li">
											<div class="li_wr">
												...
												<div class="sct_txt">
													<a href="painting_item" class="sct_a">수련연못</a>
												</div>
												<div class="sct_desc">
													<span>클로드 모네</span>
													<p>20.0cm x 35.7cm</p>
												...
												<div class="sct_cost">
													<span class="price_cost"><strong>98,000</strong>원</span><input
														type="checkbox" name="compare"> <label
														for="compare">비교하기</label>
												</div>
											</div>
										...
										<li class="sct_li">
											<div class="li_wr">
												<div class="sct_img_wrap">
													<div class="sct_img"
														style="background-image: url(../data/item/1652406531/thum04.png)">
												...
												<div class="sct_txt">
													<a href="painting_item" class="sct_a">앙티브이 아침</a>
												</div>
												<div class="sct_desc">
													<span>클로드 모네</span>
													<p>20.0cm x 35.7cm</p>
												...
												<div class="sct_cost">
													<span class="price_cost"><strong>35,700</strong>원</span><input
														type="checkbox" name="compare"> <label
														for="compare">비교하기</label>
										...
										<li class="sct_li">
											<div class="li_wr">
												<div class="sct_img_wrap">
													<div class="sct_img"
														style="background-image: url(../data/item/1652406261/thum08.png)">
												...
												<div class="sct_txt">
													<a href="painting_item" class="sct_a">지베르니 봄의 효과</a>
												</div>
												<div class="sct_desc">
													<span>클로드 모네</span>
													<p>20.0cm x 35.7cm</p>
												...
												<div class="sct_cost">
													<span class="price_cost"><strong>36,500</strong>원</span><input
														type="checkbox" name="compare"> <label
														for="compare">비교하기</label>
												</div>
											</div>
										...
										<li class="sct_li">
											<div class="li_wr">
												<div class="sct_img_wrap">
													<div class="sct_img"
														style="background-image: url(../data/item/1654135804/7JWE66qs65Oc64KY66y0.jpg)">
												...
												<div class="sct_txt">
													<a href="painting_item" class="sct_a">꽃 피는 아몬드 나무</a>
												</div>
												<div class="sct_desc">
													<span>빈센트 반 고흐</span>
													<p>20.0cm x 35.7cm</p>
										...
										<!-- 하단넘버링 2페이지 눌렀을 때 나머지그림 2개(일단 주석처리해서올림) -->
										<li class="sct_li">
											<div class="li_wr">
												<div class="sct_img_wrap">
													<div class="sct_img"
														style="background-image: url(../data/item/1653879158/7YKk7Iqk.jpg)">
												...
												<div class="sct_txt">
													<a href="painting_item" class="sct_a">키스</a>
												</div>
												<div class="sct_desc">
													<span>구스타프 클림트</span>
													<p>20.0cm x 35.7cm</p>
										...
										<li class="sct_li">
											<div class="li_wr">
												<div class="sct_img_wrap">
													<div class="sct_img"
														style="background-image: url(../data/item/1652406511/thum05.png)">
												...
												<div class="sct_txt">
													<a href="painting_item" class="sct_a">아테제 호수</a>
												</div>
												<div class="sct_desc">
													<span>구스타프 클림트</span>
													<p>20.0cm x 35.7cm</p>
										...
										<!-- 하단넘버링 2페이지 눌렀을 때 나머지그림 2개(일단 주석처리해서올림) 끝 -->
	
										<!-- 원래picture 사진작품 5개 넣어놈 -->
										<li class="sct_li">
											<div class="li_wr">
												<div class="sct_img_wrap">
													<div class="sct_img"
														style="background-image: url(../data/item/1654129940/shutterstock_423234622.jpg)">
												...
												<div class="sct_txt">
													<a href="painting_item" class="sct_a">양산을 든 여인 - 카미유와 장</a>
												</div>
												<div class="sct_desc">
													<span>클로드 모네</span>
													<p>20.0cm x 35.7cm</p>
										...
										<li class="sct_li">
											<div class="li_wr">
												<div class="sct_img_wrap">
													<div class="sct_img"
														style="background-image: url(../data/item/1654129449/7IS464qQ6rCV7J2Y67SE.png)">
												...
												<div class="sct_txt">
													<a href="painting_item" class="sct_a">세느강의 봄</a>
												</div>
												<div class="sct_desc">
													<span>클로드 모네</span>
													<p>20.0cm x 35.7cm</p>
										...
										<li class="sct_li">
											<div class="li_wr">
												<div class="sct_img_wrap">
													<div class="sct_img"
														style="background-image: url(../data/item/1653898590/7IKw7KeA6riw7J2Y7KeR.png)">
												...
												<div class="sct_txt">
													<a href="painting_item" class="sct_a">산지기의 집</a>
												</div>
												<div class="sct_desc">
													<span>구스타프 클림트</span>
													<p>20.0cm x 35.7cm</p>
												...
												<div class="sct_cost">
													<span class="price_discount"><strong>42,400</strong>원</span>
												</div>
											</div>
										</li>
										...
										<li class="sct_li">
											<div class="li_wr">
												<div class="sct_img_wrap">
													<div class="sct_img"
														style="background-image: url(../data/item/1652406619/7Jes7J24.png)">
												...
												<div class="sct_txt">
													<a href="painting_item" class="sct_a">헤르미네 갈리아의 초상</a>
												</div>
												<div class="sct_desc">
													<span>구스타프 클림트</span>
													<p>20.0cm x 35.7cm</p>
...
<div id="gotop">
    ...
    <button id="newButton" style="display:none">New Button</button> 
</div>
</div>
