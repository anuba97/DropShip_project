		  ...
		  <div class="ranking-thumb-slider">
			<div class="swiper-wrapper">
			  <div class="swiper-slide">
				<div class="ranking-img-wrap">
				  <a href="painting_item">
				    <div class="ranking-img" style="background-image:url(../data/item/1654133092/6rOg7Z2Q67K867Kg64qU64aN67aA.jpg)">
			  ...
			  <div class="swiper-slide">
				<div class="ranking-img-wrap">
				  <a href="painting_item">
				  <div class="ranking-img" style="background-image:url(../data/item/1652406953/7IiY66Co7Jew66q7.png)">
				...
				<div class="swiper-slide">
				  <div class="ranking-desc-wrap">
					...
					<div class="ranking-desc">
					  <span>클레드 모네</span><p>30cm X 30cm (두께 2.5cm)</p>
					</div>
...
<script src="../js/jquery.fancylist.js"></script>
	...
	<ul class="sct sct_20">
	  ...
	  <li class="sct_li">
		<div class="li_wr">
		  <div class="sct_img_wrap">
			<div class="sct_img" style="background-image:url(../data/item/1654133092/6rOg7Z2Q67K867Kg64qU64aN67aA.jpg)">
		  ...
		  <div class="sct_txt"><a href="painting_item" class="sct_a">수확하는 사람</a></div>
		  <div class="sct_desc"><span>빈센트 반 고흐</span><p>20.0cm x 35.7cm</p></div>
		  <div class="sct_cost"><span class="price_cost"><strong>38,200</strong>원</span></div>
		</div>
	  </li>
		...
		<li class="sct_li">
		  <div class="li_wr">
			...
			</div><div class="sct_txt"><a href="painting_item" class="sct_a">지베르니 봄의 효과</a></div>
			<div class="sct_desc"><span>클로드 모네</span><p>20.0cm x 35.7cm</p></div>
		...
		<li class="sct_li">
		  <div class="li_wr">
			...
			</div><div class="sct_txt"><a href="painting_item" class="sct_a">꽃 피는 아몬드 나무</a></div>
			<div class="sct_desc"><span>빈센트 반 고흐</span><p>20.0cm x 35.7cm</p></div>
			<div class="sct_cost"><span class="price_cost"><strong>36,500</strong>원</span></div>
		  </div>
	    </li>
	...
	<!-- 원래picture 사진작품 5개 넣어놈 -->	
		...
		<li class="sct_li">
		  <div class="li_wr">
			...
			<div class="sct_desc"><span>구스타프 클림트</span><p>20.0cm x 35.7cm</p></div>
			<div class="sct_cost"><span class="price_discount"><strong>42,400</strong>원</span></div>
		  </div>
		</li>
		...
		<li class="sct_li">
		  <div class="li_wr">
			...
			<div class="sct_desc"><span>구스타프 클림트</span><p>20.0cm x 35.7cm</p></div>
			<div class="sct_cost"><span class="price_cost"><strong>36,500</strong>원</span>
			</div>
		  </div>
		</li>	
