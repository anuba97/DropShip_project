    ...
    <div id="wrap" class="sub">
        ...
        <main id="contents">
            ...
            <section class="sub-tit-wrap" data-aos="fade-up">
                <div class="maxinner">
                    <span class="sub-txt">DropShip 자유게시판 답글 쓰기</span>
                    <h2 class="sub-tit">답글 쓰기</h2>
                </div>
            </section>
            ...
            <section id="board-write" class="board">
                <div class="maxinner">
                    <!-- 게시물 작성/수정 시작 { -->
                    <form name="fboardFrm" id="write" action="board_reply"  method="post" enctype="multipart/form-data" autocomplete="off">
						...
						<input type="hidden" name="freeBoard_group" value="${map.boardVo.freeBoard_group}">
						<input type="hidden" name="freeBoard_indent" value="${map.boardVo.freeBoard_indent}">
						<input type="hidden" name="freeBoard_step" value="${map.boardVo.freeBoard_step}">
<%-- 						<input type="hidden" name="freeBoard_head" value="${map.boardVo.freeBoard_head}"> --%>
                        ...
                        <div class="form-box-wrap">
                            ...
                            <div class="form-box">
                                ...
                                <div class="right-con">
                                    <input type="text" name="freeBoard_title" id="freeBoard_title" value="" id="qa_subject" required class="inp-type01 required" maxlength="255" placeholder="제목">
                                </div>
                            </div>
							<div class="form-box">
                                <div class="left-con">
                            ...
                            <div class="form-box">
                                ...
                                <div class="right-con">
                                    <div class="wr_content">
                                        ...
                                        <textarea id="qa_content" id="freeBoard_content" name="freeBoard_content" class="textarea-type01" maxlength="65536" style="width:100%;height:300px" placeholder="내용을 입력해주세요.">


---------------------------------
원글 :  
${map.boardVo.freeBoard_content}</textarea>
                        ...
                        <div class="btnwrap">
                            <button type="button" id="btn_submit" class="btnset btn-type01" onclick="replyBtn()" accesskey="s">
    ...
    <script>
		...
		function replyBtn(){
			if($("#freeBoard_title").val().length < 2) {
				alert("제목은 2글자 이상이어야 답글 등록이 가능합니다.");
