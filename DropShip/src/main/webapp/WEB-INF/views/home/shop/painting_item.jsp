...
<style>
	...
	.buttonReview:hover {
	  background-color:  #777; /* change the background color on hover */
	}
</style>
        ...
        <main id="contents">
            ...
            <div id="sit">
                <form name="fitem" action="https://bxgs.co.kr/shop/cartupdate.php" method="post" onsubmit="return fitem_submit(this);" style="position: relative; z-index: 1;">
                    ...
                    <input type="hidden" name="option_media" id="option_media" value="">
                    <input type="hidden" name="option_frame" id="option_frame" value="">
                    <input type="hidden" name="option_matt" id="option_matt" value="">
                    <input type="hidden" name="option_size" id="option_size" value="">
                    <input type="hidden" name="option_mattier" id="option_mattier" value="">
                    <input type="hidden" name="option_quantity" id="option_quantity" value="">
                                                    ...
                                                    function chg_opt() {
                                                        ...
                                                        if ($("input[name=opt1]:checked").val() == "1") {
                                                            ...
                                                            if ($("input[name=opt2]:checked").val() == "6") {
                                                                var html2 = '';
                                                                html2 += '<li><label><input type="radio" name="opt3" value="1" onclick="javascript:price_calculate()" checked ><div class="opt-thumb"><img src="/home/img/sub/item-detail-step04-none.jpg" alt=""></div><p>없음</p></label></li>';
                                                                html2 += '<li><label><input type="radio" name="opt3" value="2" onclick="javascript:price_calculate()" ><div class="opt-thumb"><img src="/home/img/sub/item-detail-step04-3cm.jpg" alt=""></div><p>2cm</p></label></li>';
                ...
                <div id="sit_ov_bottom">
                    <div class="sanchor-wrap" id="sanchor_pos">
                        <ul class="sanchor">
                            ...
                            <li><a href="javascript:;">상품후기<span class="item_use_count">(${workReViewCount})</span></a></li>
                    ...
                    <div id="sit_use" class="sit_con">
                        <div class="maxinner">
                            ...
                            <div id="itemgrade">
                                <div class="left">
                                    <strong class="grade-total">3.4</strong>
                                ...
                                <div class="right">
                                    <ul>
                                        ...
                                        <li class="on">
                                            ...
                                            <div class="grade-graph">
                                                <div class="grade-bar" style="width:75%;"></div>
                                            </div>
                                        ...
                                        <li>
                                            ...
                                            <div class="grade-graph">
                                                <div class="grade-bar" style="width:50%;"></div>
                                            </div>
                                            <div class="grade-score">50%</div>
                                        </li>
                                        <li>
                            ...
                            <div id="itemuse">
                                ...
                                <div id="sit_use_tit">
                                    ...
                                    <div class="sit_use_order">
                                            <button class="buttonReview" id="newest" onclick="reviewSortBtn(${workVo.id}, 'newest')"><span>최신순</span></button>
											<button class="buttonReview" id="highest" onclick="reviewSortBtn(${workVo.id}, 'highest')"><span>평점높은순</span></button>
											<button class="buttonReview" id="lowest" onclick="reviewSortBtn(${workVo.id}, 'lowest')"><span>평점낮은순</span></button>
                                    </div>
                                </div>
								
								<c:if test="${workReViewCount == 0 }"> 
	                                <div id="sit_use_list">
								...
								<c:if test="${workReViewCount != 0 }"> 
								    <div id="reviewSection">
								        <c:forEach items="${workReViewList}" var="workReViewList">
								            <div id="sit_use_list">
								                <ol id="sit_use_ol">
								                    <li class="sit_use_li">
								                        <button type="button" class="sit_use_li_title">${workReViewList.review_title}</button>
								                        <dl class="sit_use_dl">
								                            <dt>선호도</dt>
								                            <dd class="sit_use_star">
								                                <c:if test="${workReViewList.review_rate == 1}">
								                                    <img src="../../home/img/s_star1_big.png" alt="별1개">
								                                </c:if>
								                                <c:if test="${workReViewList.review_rate == 2}">
								                                    <img src="../../home/img/s_star2_big.png" alt="별2개">
								                                </c:if>
								                                <c:if test="${workReViewList.review_rate == 3}">
								                                    <img src="../../home/img/s_star3_big.png" alt="별3개">
								                                </c:if>
								                                <c:if test="${workReViewList.review_rate == 4}">
								                                    <img src="../../home/img/s_star4_big.png" alt="별4개">
								                                </c:if>
								                                <c:if test="${workReViewList.review_rate == 5}">
								                                    <img src="../../home/img/s_star5_big.png" alt="별5개">
								                                </c:if>
								                            </dd>
								                            <dt>작성자</dt>
								                            <dd class="sit_use_name">${workReViewList.member_nName}</dd>
								                            <dt>작성일</dt>
								                            <dd class="sit_use_time">${workReViewList.review_date}</dd>
								                        </dl>
								                        <div id="sit_use_con_0" class="sit_use_con">
								                            <div class="sit_use_p">
								                                <p>${workReViewList.review_content}</p>                
								                            </div>
								                        </div>
								                    </li>
								                </ol>
								...
								<script>
								// 리뷰기능 : 최신순, 별점높은순, 별점낮은순
								function reviewSortBtn(work_id, sort_id){
									$.ajax({
								        url: "../shop/workReviewSort_ajax",
								        type: "POST",
								        dataType: "json",
								        data: {"work_id":work_id, "sort_id":sort_id},
								        
								        success: function(response){
								            
								        	console.log(response.workReViewList);
 								        	// 동적으로 생성하는 부분
 								        	let text = "";
								        	for (let i = 0; i< response.workReViewList.length; i++){
 								        		let workReViewVo = response.workReViewList[i];
 								        		
 								        		text += '<div id="reviewSection" ' + i + '>';
 								        		text += '<div id="sit_use_list">';
 								        		text += '<ol id="sit_use_ol">';
 								        		text += '<li class="sit_use_li">';
 								        		text += ' <button type="button" class="sit_use_li_title">' + workReViewVo.review_title + '</button>';                   
 								        		text += '<dl class="sit_use_dl">';
 								        		text += '<dt>선호도</dt>';
 								        		text += '<dd class="sit_use_star">';
								        		if (workReViewVo.review_rate == 1){
								        			text += "<img src='/home/img/s_star1_big.png' alt='별1개'>"
								        		}
								        		if (workReViewVo.review_rate == 2){   
								        			text += '<img src="/home/img/s_star2_big.png" alt="별2개">'
								        		}
								        		if (workReViewVo.review_rate == 3){  
								        			text += '<img src="http://localhost:8080/home/img/s_star3_big.png" alt="별3개">'
								        		}
								        		if (workReViewVo.review_rate == 4){  
								        			text += '<img src="http://localhost:8080/home/img/s_star4_big.png" alt="별4개">'
								        		}
								        		if (workReViewVo.review_rate == 5){  
								        			text += '<img src="http://localhost:8080/home/img/s_star5_big.png" alt="별5개">'
								        		}
								        		text += '</dd>';
								        		text += '<dt>작성자</dt>';
								        		text += '<dd class="sit_use_name">' + workReViewVo.member_nName + '</dd>';
								        		text +=  '<dt>작성일</dt>';
								        		text += '<dd class="sit_use_time">' + workReViewVo.review_date + '</dd>';
								        		text += '</dl>';
								        		text += '<div id="sit_use_con_0" class="sit_use_con">';
								        		text += '<div class="sit_use_p">';
								        		text += '<p>' + workReViewVo.review_content + '</p> ';
								        		text += '</div>';
								        		text += '</div>';
								        		text += '</li>';
								        		text += '</ol>';
								        	...
								        	$('#reviewSection').html(text);   // text들을 html형태로 div(id="reviewSection")안에 뿌려준다
								        	// ajax으로 불러온 데이터들 때문에 이벤트가 걸려있던 객체가 사라져서 다시 스크롤(이벤트)를 설정해줌.
