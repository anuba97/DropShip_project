...
<body>
                    ...
                    <form name="workReviewUpdate" id="workReviewUpdate" action="../shop/work_review_update"  method="post" enctype="multipart/form-data" autocomplete="off">
                        ...
                        <div class="form-box-wrap">
                            ...
                            <div class="form-box">
                                ...
                                <div class="right-con">
                                    <input type="text" name="review_title" id="review_title" value="${workReViewVo.review_title}" required class="inp-type01 required" maxlength="30" placeholder="제목">
                                </div>
                            </div>
                            ...
                            <div class="form-box">
                                ...
                                <div class="right-con">
                                    <select name="review_rate" id="review_rate" class="deco-select">
	                                    <option value="5" <c:if test="${workReViewVo.review_rate == 5}">selected</c:if>>5</option>
									    <option value="4" <c:if test="${workReViewVo.review_rate == 4}">selected</c:if>>4</option>
									    <option value="3" <c:if test="${workReViewVo.review_rate == 3}">selected</c:if>>3</option>
									    <option value="2" <c:if test="${workReViewVo.review_rate == 2}">selected</c:if>>2</option>
									    <option value="1" <c:if test="${workReViewVo.review_rate == 1}">selected</c:if>>1</option>
									</select>
                            ...
                            <div class="form-box">
                                ...
                                <div class="right-con">
                                    <div class="wr_content">
                                        ...
                                        <textarea id="review_content" name="review_content" class="textarea-type01" maxlength="199" style="width:100%;height:300px" placeholder="내용을 입력해주세요.">${workReViewVo.review_content}</textarea>
                        ...
                        <div class="btnwrap">
                            <button type="button" id="btn_back" class="btnset btn-type01" onclick="work_ReviewBackBtn()" accesskey="s" style="font-weight: bold; " >
                            ...
                            <button type="button" id="btn_update" class="btnset btn-type01" onclick="work_ReviewUpdateBtn()" accesskey="s" style=" color:blue; margin-left : 20px; " >
                                <svg height="50" width="180">
                                    <rect height="50" width="180"></rect>
                                </svg>
                                <span>수정하기</span>
                            ...
                            <button type="button" id="btn_delete" class="btnset btn-type01" onclick="work_ReviewDeleteBtn()" accesskey="s" style=" color:red; margin-left : 20px; " >
                                <svg height="50" width="180">
                                    <rect height="50" width="180"></rect>
                                </svg>
                                <span>삭제하기</span>
	...
	<script>
		...
		// 뒤로가기 버튼
		function work_ReviewBackBtn(){
			window.history.back();
		}//work_ReviewBackBtn
		
		// 작품리뷰 수정 버튼
		function work_ReviewUpdateBtn(){
