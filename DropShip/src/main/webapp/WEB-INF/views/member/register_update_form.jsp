...
<section class="join">
    <div class="maxinner">
        ...
        <div class="join-form-wrap">
            <form name="fregisterform" id="fregisterform" action="register_update_result" onsubmit="return fregisterform_submit(this);" method="post" enctype="multipart/form-data" autocomplete="off">
                ...
                <div class="form-box-wrap">
                    <div class="form-box">
                        ...
                        <div class="right-con">
                            <div class="box-id">
                                <input type="text" name="mb_id" value="동순옹과 아이들" id="reg_mb_id" class="inp-type01 half  readonly" minlength="3" maxlength="20"  readonly placeholder="아이디">
                                                            </div>
                    ...
                    <div class="form-box">
                        ...
                        <div class="right-con">
                            <input type="text" id="reg_mb_name" name="mb_name" value="동순옹과 아이들"  readonly class="inp-type01 half  readonly" placeholder="이름">
                                                                                </div>
                    </div>
                    ...
                    <div class="form-box">
                        ...
                        <div class="right-con">
                                                        <input type="hidden" name="old_email" value="alstn85852@naver.com">
                            <input type="email" name="mb_email" value="alstn85852@naver.com" id="reg_mb_email" required class="inp-type01 half email required" size="50" maxlength="100" placeholder="E-mail">
                        </div>
                    </div>
                        ...
                        <div class="right-con">
                            <input type="text" name="mb_tel" value="028394015" id="reg_mb_tel" class="inp-type01 half " maxlength="20"  placeholder="전화번호">
                        </div>
                    </div>
                    ...
                    <div class="form-box">
                        ...
                        <div class="right-con">
                            <div class="box-birth">
                                <select name="mb_1" id="mb_1" class="deco-select" required>
                                ...
                                <select name="mb_2" id="mb_2" class="deco-select" required>
                                ...
                                <select name="mb_3" id="mb_3" class="deco-select" required>
                                                                            <option value="01">01</option>
                                                                            <option value="02">02</option>
                                                                            <option value="03">03</option>
                                                                            <option value="04">04</option>
                        ...
                        <div class="right-con">
                            <div class="box-adress">
                                ...
                                <input type="text" name="mb_zip" value="08555" id="reg_mb_zip" required class="inp-type01 required" size="5" maxlength="6" placeholder="우편번호">
                            ...
                            <div class="box-adress-inp">
                                ...
                                <input type="text" name="mb_addr1" value="서울 금천구 독산동 181-34" id="reg_mb_addr1" required class="inp-type01 required" size="50" placeholder="기본주소"><br>
                                <label for="reg_mb_addr2" class="sound_only">상세주소</label>
                                <input type="text" name="mb_addr2" value="3층" id="reg_mb_addr2" required class="inp-type01 required" size="50" placeholder="상세주소">
                            </div>
...
<span id="captcha_info">자동등록방지 숫자를 순서대로 입력하세요.</span>
                ...
                <div class="btn-confirm-wrap">
                    ...
                    <button type="submit" id="btn_submit" class="btnset btn-type04 btn-line-brown" accesskey="s">수정</button>
                </div>
            </form>
        </div>
    </div>
