...
<title>DropShip 갤러리 오픈하였습니다. > 공지사항 | DropShip 갤러리</title>
...
<div id="wrap" class="sub">
        ...
        <div class="sitemap">
            <div class="inner">
                ...
                <nav class="info-menu-wrap">
                    ...
                    <ul class="info-menu">
                                                    <li><a href="https://bxgs.co.kr/bbs/login.php">로그인</a></li>
                            <li><a href="https://bxgs.co.kr/bbs/register_intro.php">회원가입</a></li>
        ...
        <ul class="gnb-info">
            ...
            <li><a href="https://bxgs.co.kr/shop/cart.php">장바구니<span class="basket-num">0</span></a></li>
...
<article id="board-view" class="board">
    <div class="maxinner">
        <header class="board-con-tit">
            <span>NOTICE</span>
            <h2>
                DropShip 갤러리 오픈하였습니다.            </h2>
            <p><span class="hide">작성일</span>2022.05.12</p>
        </header>
        ...
        <div class="board-con-wrap">
            ...
            <div class="board-con"><p>안녕하세요. DropShip입니다.</p><p>DropShip 갤러리 몰 오픈하였습니다.</p><p>여러분들의 많은 관심 부탁드립니다.</p><p><br></p><p>감사합니다.</p><p>&nbsp;</p></div>
        ...
        <div class="board-con-move">
                ...
                <li class="mid"><a href="https://bxgs.co.kr/bbs/board.php?bo_table=notice"><span class="hide">목록으로</span></a></li>
                <li class="next">
