...
<html>
			...
			function fboardBtn(){
				...
				if(confirm("글을 저장하시겠습니까?")){
					...
					$.ajax({
						...
						data : new FormData($("#fboardFrm")[0]),	/* data,processData, cache꼭 enctype도 필요 */
						processData:false,
						contentType:false,
						cache:false, 
						success:function(data){
							alert("성공");
							location.href = "/board/fboardList";
						},
						error:function(){
							alert("실패");
						}
	...
	<body>
		<h2>자유게시판 글쓰기</h2>
		<form action="fboardWrite3" method="post" name="fboardFrm" id="fboardFrm" enctype="multipart/form-data"> 
			<table>
				<colgroup>
					<col width="30%">
					<col width="70%">
