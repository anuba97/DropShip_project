		...
		<script>
			function deleteBtn(){
				if(confirm("게시글을 삭제하시겠습니까?")) 
					location.href="fboardDelete?bno=${boardVo.bno}&page=${page}&searchTitle=${searchTitle}&searchWord=${searchWord}";
			} // deleteBtn()
			
			function updateBtn(){
				if(confirm("게시글을 수정하시겠습니까?")) 
					location.href="fboardUpdate?bno=${boardVo.bno}&page=${page}&searchTitle=${searchTitle}&searchWord=${searchWord}";
			}//updateBtn()
		</script>
	</head>
	<body>
