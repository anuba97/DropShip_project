	                                            ...
	                                            <div class="sod_product">
	                                                ...
	                                                <div class="sod_name">
	                                                    <a href="../shop/painting_item?id=${workVoList[loop.index].id}" class="prd_name">
	                                                        ...
	                                                        <span>${workVoList[loop.index].artist_name}</span>
	                                                    </a>
	                                                    <div class="sod_opt">
	                                                        <ul>
                        ...
                        <div class="fin_total_box_wrap">
                            <div class="fin_total_box">
                                <div class="fin_total_top">
                                    ...
                                    <div class="fin_total_price"><strong>${order_total_price+2000}</strong> 원</div><!--나중에 리스트로 받아오는거 구현하고 해야  -->
                                </div>
                                <div class="fin_total_btm">
                                    <div class="fin_total_cate">주문금액</div>
                                    <div class="fin_total_price"><strong>${order_total_price}</strong> 원</div>
                                </div>
                                <div class="fin_total_btm">
                            ...
                            <div class="fin_total_box">
                                <div class="fin_total_top">
                                    ...
                                    <div class="fin_total_price"><strong class="f-color">${order_total_price+2000}</strong> 원</div>
                                </div>
                                <div class="fin_total_btm">
                                    <div class="fin_total_cate">총 주문금액</div>
