            ...
            <article id="board-view" class="board">
                <div class="maxinner">
                    <header class="board-con-tit">
                    	<c:if test="${map.boardNoticeVo.getNoticeboard_istop() == '1'}">
                        	<span>NOTICE</span>
                        </c:if>
                        <c:if test="${map.boardNoticeVo.getNoticeboard_istop() == '0'}">
                        	<span>공지</span>
                        </c:if>
                        <h2>${map.boardNoticeVo.getNoticeboard_title()}</h2>
                        <p><span class="hide">작성일</span>
                        	작성일: <fmt:formatDate value="${map.boardNoticeVo.getNoticeboard_date()}" pattern="yyyy-MM-dd HH:mm:ss"/><br>
                        	최종 수정일: <fmt:formatDate value="${map.boardNoticeVo.getNoticeboard_update_date()}" pattern="yyyy-MM-dd HH:mm:ss"/>
                        </p>
                    </header>
                    <div class="board-con-wrap">
                        <h3 class="hide">본문</h3>
                        <div class="board-con">
                            ${map.boardNoticeVo.getNoticeboard_content()}
                        </div><br>
                    <p>
						<span class="hide">첨부파일</span>
						<c:if test="${map.boardNoticeVo.getNoticeboard_file_name() != null}">
                        	<img src="../admin/upload/${map.boardNoticeVo.getNoticeboard_file_name()}" style="width:700px;">
                        </c:if>
						<c:if test="${map.boardNoticeVo.getNoticeboard_file_name() == null}">
                        	첨부파일: 첨부파일이 없습니다.
                        </c:if>
                    ...
                    <div class="board-con-move">
                        <ul>
                            ...
                            <li class="mid" ><a href="notice?page=${page}"><span class="hide">목록으로</span></a></li>
