...
<!-- Mirrored from bxgs.co.kr/bbs/board.php?bo_table=event by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 08 Feb 2023 07:03:31 GMT -->
...
<title>EVENT 1 페이지 | DropShip 갤러리 zzz</title>
    ...
    <div class="maxinner">
		...
		<form name="fboardlist"  id="fboardlist" action="https://bxgs.co.kr/bbs/board_list_update.php" onsubmit="return fboardlist_submit(this);" method="post">
			...
			<input type="hidden" name="sw" value="">
                ...
                <ul id="bo_cate_ul">
                    <li><a href="all_event?bo_table=event" id="bo_cate_on">전체보기</a></li><li><a href="pro_event?bo_table=event&amp;sca=%EC%A7%84%ED%96%89%EC%A4%91+%EC%9D%B4%EB%B2%A4%ED%8A%B8">진행중 이벤트</a></li><li><a href="final_event?bo_table=event&amp;sca=%EC%A2%85%EB%A3%8C%EB%90%9C+%EC%9D%B4%EB%B2%A4%ED%8A%B8">종료된 이벤트</a></li>                </ul>
            </nav>
            ...
            <div class="grid-event-list">
                                <ul id="gall_ul">
                                        <li>
                                                    ...
                                                    <a href="boardaa9c.html?bo_table=event&amp;wr_id=25">
                            ...
                            <div class="event-info">
                                                                <h3>회원가입 시 쿠폰팩발급</h3>
                                <p>지금 가입하신 신규 회원님께 쿠폰팩을 증정합니다.</p>
                                <span class="date">2022-05-10 ~ 2022-05-10</span>
                                        ...
                                        <li>
                                                    ...
                                                    <a href="boardd3a5.html?bo_table=event&amp;wr_id=24">
                                                    <div class="event-thumb">
                            ...
                            <div class="event-info">
                                                                <h3>11월 블랙프라이데이 이벤트</h3>
                                <p>블프 기간 한정! 전품목 최대 67% 할인!</p>
                            ...
                            <a href="javascript:;" class="event-end">
                                                    <div class="event-thumb">
                                                                    <div class="imgbox" style="background-image:url(../data/file/event/3696002221_5Ex9kDw0_51f7a3986befb00cad1caf54b33ea5459e8bd50b.png)"><span class="hide">썸네일</span></div>
                                                                                                
                                    <div class="event-end-box">종료된 이벤트입니다.</div>                                  
                                                            </div>
                            <div class="event-info">
                                                                <h3>1월 COUPON PACK!</h3>
                                <p>1월 COUPON PACK!</p>
                                <span class="date">2022-05-10 ~ 2022-05-10</span>
                            </div>
                        </a>
...
<!-- Mirrored from bxgs.co.kr/bbs/board.php?bo_table=event by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 08 Feb 2023 07:03:33 GMT -->
</html>
