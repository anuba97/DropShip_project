...
<!-- Mirrored from bxgs.co.kr/shop/personalpay.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 08 Feb 2023 07:03:41 GMT -->
...
<title>개인결제 리스트 | DropShip 갤러리</title>
...
<section class="sub-tit-wrap" data-aos="fade-up">
    <div class="maxinner">
                ...
                <h2 class="sub-tit">PERSONAL PAY</h2>
    </div>
</section>
...
<!-- 개인결제진열 시작 { -->
<div class="grid-list">
<ul id="sct_wrap" class="sct sct_pv">
 
    <li class="sct_li">
        <div class="sct_img_wrap">
            <div class="sct_img">
                <img src="../img/ico/ico-personal-pay.png" alt="">
                <strong>개인결제창</strong>
                <p>Personal Pay</p>
            </div>
            <div class="sct_opt_wrap">
                <div class="sct_btn">
                    <a href="personalpayform"class="btnset btn-type01">
        ...
        <div class="sct_txt"><a href="personalpayform" class="sct_a">SORO님의 개인결제창입니다</a></div>
        <div class="sct_cost">
...
<!-- Mirrored from bxgs.co.kr/shop/personalpay.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 08 Feb 2023 07:03:42 GMT -->
</html>
