    ...
    <script>
	    function updateBtn() {
	        if (confirm("해당 공지사항을 수정 하시겠습니까?")) {
	        	admin_noticeBoardUpdateFrm.submit();
	        }
	    }//updateBtn
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h1 class="mt-4">공지 수정</h1>
                    <div class="card mb-4">
                        <div class="card-body">DropShip 공지를 수정하는 메뉴입니다. 내용에 맞게 수정해주세요.</div>
                    </div>
                </div>
                <div>
                    <table class="admin_noticeBoardAdd">
                        <form action="admin_noticeBoardUpdate" name="admin_noticeBoardUpdateFrm" method="post" enctype="multipart/form-data">
                            <colgroup>
                                <col width="25%">
                                <col width="75%">
                            </colgroup>
	                        <input type="hidden" id="id" name="id" value=${boardNoticeVo.getId()}>
	                        <input type="hidden" name="original_file" value="${boardNoticeVo.getNoticeboard_file_name()}">
                            <tr>
                                <th><label for="noticeboard_title">공지 제목</label></th>
                                <td><input type="text" id="noticeboard_title" name="noticeboard_title" style="width:100%;" value="${boardNoticeVo.getNoticeboard_title()}"></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <textarea id="noticeboard_content" name="noticeboard_content" cols="50" rows="10" style="width:100%;">${boardNoticeVo.getNoticeboard_content()}</textarea>
                                </td>
                            ...
                            <tr>
                                <th><label for="noticeboard_update_date">최종 수정일</label></th>
                                <input type="hidden" id="noticeboard_update_date" name="noticeboard_update_date" value="${boardNoticeVo.getNoticeboard_update_date()}">
                    ...
                    <div class="admin_noticeBoard_div">
                        <button type="button" class="admin_noticeBoard_button" onclick="updateBtn()" style="margin: 0 0 0 400px; color:blue; border-radius:5px;">수정 완료</button>
