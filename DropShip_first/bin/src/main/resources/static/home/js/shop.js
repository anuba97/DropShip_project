...
function price_calculate()
{
	...
	var arr_opt4_price = {0:0, 1:1000, 2:2000, 3:3000, 4:4000, 5:5000, 6:6000, 7:7000, 8:8000}
    ...
    $el_prc.each(function(index) {
        ...
        if(type == "0") { // 선택옵션
            total += (it_price + price + add_opt2 + add_opt3 + add_opt4) * qty;
        } else { // 추가옵션
            total += (price + add_opt2 + add_opt3 + add_opt4) * qty;
        }
    });
