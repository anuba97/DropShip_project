                    ...
                    <div class="sod_fin_list" id="sod_fin_list">
                        ...
                        <div class="tbl_order tbl_wrap">
                            <table>
                                ...
                                <tbody>
                                	<c:forEach items="optionVoList" var="optionVo" varStatus="iteration">
	                                    <tr>
	                                        <td data-title="No" class="td_no"></td>
	                                        <td data-title="Product" class="td_prd">
	                                            <div class="sod_product">
	                                                <div class="sod_img">
	                                                    <a href="../shop/painting_item?id=${workVo.work_id}" style="background-image:url(../admin/img/work/${workVo.work_img_url})">
                        ...
                        <div class="fin_total_box_wrap">
                            ...
                            <div class="fin_total_box">
                                <div class="fin_total_top">
                                    ...
                                    <div class="fin_total_price"><strong class="f-color">${order_Detail_inquire_viewVo.option_selected_price * order_Detail_inquire_viewVo.option_quantity+2000}</strong> 원</div>
                                </div>
                                <div class="fin_total_btm">
                                    <div class="fin_total_cate">총 주문금액</div>
                                    <div class="fin_total_price"><strong>${order_Detail_inquire_viewVo.option_selected_price * order_Detail_inquire_viewVo.option_quantity+2000}</strong> 원</div>
                                </div>
                                <div class="fin_total_btm">
