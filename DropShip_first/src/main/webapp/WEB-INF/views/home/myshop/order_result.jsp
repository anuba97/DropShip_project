                                    ...
                                    <tr>
                                        ...
                                        <td data-title="Product" class="td_prd">
                                            <div class="sod_product">
                                                <div class="sod_img">
                                                    <a href="https://bxgs.co.kr/shop/item.php?it_id=1652406953" style="background-image: url(/admin/img/work/${workVo.work_img_url})">
                                                        <span class="hide">제품이미지</span>
                                                    </a>
                                                </div>
                                                <div class="sod_name">
                                                    <a href="../shop/painting_item?id=${workVo.id}" class="prd_name">
                                                        <strong>${workVo.work_name}</strong>
                                                        <span>${workVo.artist_name}</span>
                                                    </a>
                                                    <div class="sod_opt">
                                                        <ul>
                                        ...
                                        <td data-title="Unit price" class="td_numbig text_right">${workVo.work_price} 원</td>
                    ...
                    <div class="sod_fin_total">
                        ...
                        <div class="fin_total_box_wrap">
                            <div class="fin_total_box">
                                ...
                                <div class="fin_total_btm">
                                    <div class="fin_total_cate">배송비</div>
                                    <div class="fin_total_price"><strong>2,000</strong> 원</div>
                                </div>
                            </div>
                            ...
                            <div class="fin_total_box">
                                <div class="fin_total_top">
                                    ...
                                    <div class="fin_total_price"><strong class="f-color">${optionVo.option_selected_price * optionVo.option_quantity+2000}</strong> 원</div>
                                </div>
                                <div class="fin_total_btm">
                                    <div class="fin_total_cate">총 주문금액</div>
